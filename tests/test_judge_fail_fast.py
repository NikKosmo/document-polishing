...
class TestJudgeFailureError:
    ...
    def test_exception_attributes(self):
        ...
        error = JudgeFailureError(section_id="section_0", reason="Judge query timeout", details="Timeout after 300s")
    ...
    def test_exception_message_format(self):
        ...
        error = JudgeFailureError(section_id="section_5", reason="Invalid response", details="Missing 'agree' field")
    ...
    def test_exception_without_details(self):
        ...
        error = JudgeFailureError(section_id="section_0", reason="Unknown error")
...
class TestLLMJudgeStrategyFailFast:
    ...
    def test_valid_response_does_not_raise(self):
        ...
        def valid_query_func(prompt):
            return {"agree": True, "similarity": 0.9, "explanation": "Models agree", "key_differences": []}
...
class TestAmbiguityDetectorFailFast:
    ...
    def test_detect_raises_on_judge_failure(self):
        ...
        detector = AmbiguityDetector(strategy="llm_judge", llm_query_func=error_query_func)
    ...
    def test_detect_stops_at_first_judge_failure(self):
        ...
        detector = AmbiguityDetector(strategy="llm_judge", llm_query_func=failing_query_func)
